...
class BeeClassifierNet:
    ...
    # exhasutive search models
    def exhaustModel1(self, tensorWidth, tensorHeight, tensorDepth):
    ...
    def exhaustModel2(self, tensorWidth, tensorHeight, tensorDepth):
        aug = tflearn.ImageAugmentation()
    ...
    def exhaustModel4(self, tensorWidth, tensorHeight, tensorDepth):
        aug = tflearn.ImageAugmentation()
    ...
    def exhaustModel5(self, tensorWidth, tensorHeight, tensorDepth):
        aug = tflearn.ImageAugmentation()
    ...
    def vggNet(self,tensorWidth,tensorHeight,tensorDepth):
    ...
    def resNet(self,tensorWidth,tensorHeight,tensorDepth):
        n = 5
    ...
    def PrateekVats(self, tensorWidth, tensorHeight, tensorDepth):
        # g = tf.Graph()
        # with g.as_default():
        aug = tflearn.ImageAugmentation()
    ...
    def AdamKing(self, tensorWidth, tensorHeight, tensorDepth):
        ...
        with g.as_default():
            ...
            conv_net = fully_connected(
                conv_net, 100, activation='sigmoid')
